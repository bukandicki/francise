      ...
      <div class="container pt-5">
         <div class="row">
            <div class="col-lg-12 mb-5 pb-5">
               <h1>Create <strong class="text-success">Discount</strong></h1>
               <div class="form-group mt-4">
                  <label for="">Promo Name</label>
                  <input
                     type="text"
                     class="form-control w-75"
                     placeholder="Promo 17 agustus.."
               ...
               <div class="form-group">
                  ...
                  <textarea
                     ...
                     placeholder="Merayakan HUT Indonesia..."
                     v-model="promoNewData.desc"
                  ></textarea>
               </div>
               <button
                  class="btn btn-info rounded-pill"
                  @click="addPromo"
                  :disabled="disabledButton(promoNewData)"
               >
                  Add Promo
               </button>
            </div>
                     ...
                     <div class="form-check d-flex align-items-center px-1">
                        ...
                        >
                           <div>
                              <span>{{ item.name }}</span>
                              <span
                                 class="badge badge-pill align-self-center p-2 badge-success mx-2 px-3"
                                 >{{ item.amount }}%</span
                              >
                              <span
                                 class="badge badge-pill align-self-center p-2 badge-info px-3"
            ...
            <div class="col-lg-12 mt-5" v-if="!isHiddenEditPromo">
               <h1>Edit <strong class="text-success">Discount</strong></h1>
               <div class="form-group mt-4">
                  <label for="">Promo Name</label>
                  <input
                     type="text"
               ...
               <div class="form-group">
                  ...
                  <textarea
                     ...
                     id="exampleFormControlTextarea1"
                     placeholder="Merayakan HUT Indonesia..."
                     v-model="promoEdit.desc"
                  ></textarea>
               </div>
               <button
                  class="btn btn-info rounded-pill"
                  @click="btnEditPromo"
                  :disabled="disabledButton(promoEdit)"
               >
                  Edit Promo
               </button>
            </div>
...
export default {
   ...
   methods: {
      ...
      deletePromo(id) {
         swal({
            ...
            if (willDelete) {
               axios
                  .delete("https://franchise-backend.herokuapp.com/promo/" + id)
                  .then(() => {
      ...
      addPromo() {
         if (this.promoNewData) {
            axios
               .post(
                  "https://franchise-backend.herokuapp.com/promo",
                  this.promoNewData
               )
               .then(() => {
                  swal(
      ...
      btnEditPromo() {
         axios
            ...
            .then(() => {
               swal("Promo " + this.promoEdit.name + " berhasil di edit!", {
                  icon: "success",
               });
            })
            .catch((error) => console.log(error));
   ...
   mounted() {
      // this.getPromos();
      // this.promos
      // console.log("Updated ", this.promos)
   },
};
</script>
