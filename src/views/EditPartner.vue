      ...
      <div class="container pt-5">
         ...
         <div class="row">
            <div class="col-md-5">
               ...
               <button
                  @click="chooseImage"
                  class="btn btn-info text-light mt-2 rounded-pill"
               >
                  Change Image
               </button>
            </div>
            <div class="col-md-7">
               <h1 class="mb-4">
                  Edit <strong class="text-success">Partner</strong>
               </h1>
               ...
               <div class="form-group my-2 mb-3 d-flex flex-column">
                  ...
                  <select
                     class="my-2 "
                     v-model="partnerEdit.location.province"
                     name=""
                     id=""
                  >
                     <option value="Jawa Timur">Jawa Timur</option>
                     <option :value="partnerEdit.location.province">{{
                        partnerEdit.location.province
                     }}</option>
                     <option value="Jawa Tengah">Jawa Tengah</option>
                  </select>
                  <select
                     class=""
                     v-model="partnerEdit.location.city"
                     name=""
                     id=""
                  >
                     <option value="Surabaya">Surabaya</option>
                     <option :value="partnerEdit.location.city">{{
                        partnerEdit.location.city
                     }}</option>
               ...
               <div class="form-group my-2">
                  ...
                  <input
                     type="text"
                     class="form-control font-weight-bold"
                     v-model="partnerEdit.location.street_name"
                     :placeholder="partnerEdit.location.street_name"
                  />
               </div>
               <div class="form-group my-2">
                  ...
                  <input
                     type="number"
                     class="form-control font-weight-bold"
                     v-model="partnerEdit.location.post_code"
                     :placeholder="partnerEdit.location.post_code"
                  />
               </div>
                  ...
                  >
                     <div class="form-check d-flex align-items-center">
                        ...
                        >
                           <span>{{ item.name }}</span>
                           <span
                              class="badge badge-pill align-self-center p-2 badge-success d-block ml-2 px-3"
                              >Rp{{ item.price }}</span
                           >
                        </label>
                     </div>
               ...
               <ul class="list-group mb-5 pt-2">
                  ...
                  <li class="list-group-item mt-2 border-0">
                     <button class="btn btn-danger w-100" @click="resetPromo">
                        Reset Promo
                     </button>
                  </li>
               </ul>
               <button
                  class="btn btn-success mt-3 rounded-pill px-4 py-2"
                  @click="confirmEdits"
               >
                  Confirm Edit
               </button>
